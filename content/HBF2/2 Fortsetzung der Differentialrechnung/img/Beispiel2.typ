...
#let function11 = x11.map(x =>  (2*x*x - 4) / (3*x*x + 5))
#let function12 = x12.map(x =>  (2*x*x - 4) / (3*x*x + 5))
...
#lq.diagram(
  ...
  lq.plot(x11, function11, mark: none, stroke: thirdcolor + 1.5pt, label: [$display(f(x) = (2x^2 - 4) / (3x^2 + 5))$]),
