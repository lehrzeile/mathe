...
#let x11 = lq.linspace(-100, -2-1/10000, num: 5000)
#let x12 = lq.linspace(-2+1/10000, 100, num: 5000)

#let function11 = x11.map(x =>  (0.125 * x*x + 1) / (x + 2))
#let function12 = x12.map(x =>  (0.125 * x*x + 1) / (x + 2))
...
#lq.diagram(
  ...
  lq.plot(x11, function11, mark: none, stroke: secondcolor + 1.5pt, label: [$f_1(x) = (1/8 x^2 + 1)/(x + 2)$]),
  lq.plot(x12, function12, mark: none, stroke: secondcolor + 1.5pt),
  // lq.plot((-2, -2), (-5.5, 5.5), stroke: (paint: red, thickness: 1.5pt, dash: "dashed"), mark: none),
)