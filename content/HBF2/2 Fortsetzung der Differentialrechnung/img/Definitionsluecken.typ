...
#let x11 = lq.linspace(-100, -2 - 1/20, num: 5000)
#let x12 = lq.linspace(-2 + 1/20, 1 - 1/10000, num: 5000)
#let x13 = lq.linspace(1 + 1/10000, 100, num: 5000)
#let ys = lq.linspace(-100, 100, num: 5000)

#let function11 = x11.map(x =>  (x + 2) / ((x - 1)*(x + 2)))
#let function12 = x12.map(x =>  (x + 2) / ((x - 1)*(x + 2)))
#let function13 = x13.map(x =>  (x + 2) / ((x - 1)*(x + 2)))
