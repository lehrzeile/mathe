...
#let function2 = xs.map(x =>  0.6*x*x - 2.8*x)
#let function3 = xs.map(x =>  1.2*x - 2.8)
...
#lq.diagram(
  ...
  lq.plot(xs, function2, mark: none, stroke: red.darken(30%) + 1.5pt, label: [$f'$]),
  lq.plot(xs, function3, mark: none, stroke: green.darken(30%) + 1.5pt, label: [$f''$]),
  // Hilfslinien für Extrem- und Wendestellen
  ...
  lq.plot((2.33, 2.33), (-3.25, 2.1), stroke: (paint: red, thickness: 1.5pt, dash: "dashed"), mark: none),
  // Markierungen
  lq.place(3.1, -4.5, align: left)[#text(9pt, font: "Roboto")[Extremstelle = \ Nullstelle der 1. Ableitung]],
  lq.place(4.67, -3.5, align: center + horizon)[#text(17pt, font: "Roboto")[$arrow.t$]],
  lq.place(1.1, 8, align: left)[#text(9pt, font: "Roboto")[Extremstelle = \ Nullstelle der 1. Ableitung]],
  lq.place(0.5, 7.7, align: center + horizon)[#text(17pt, font: "Roboto")[$arrow.bl$]],
  lq.place(3.1, 3.75, align: left)[#text(9pt, font: "Roboto")[Wendestelle = \ Nullstelle der 2. Ableitung und \ Extremstelle der 1. Ableitung]],
  lq.place(2.8, 2.6, align: center + horizon)[#text(17pt, font: "Roboto")[$arrow.bl$]],
)