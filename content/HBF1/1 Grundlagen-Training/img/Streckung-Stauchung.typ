...
#let function4 = xs.map(x =>  0.5*x*x)
...
#lq.diagram(
  ...
  lq.plot(xs, function1, mark: none, stroke: secondcolor + 1.5pt, label: [$f(x)=x^2$]),
  lq.plot(xs, function2, mark: none, stroke: maincolor + 1.5pt, label: [$f(x)=-x^2$]),
  lq.plot(xs, function3, mark: none, stroke: green.darken(30%) + 1.5pt, label: [$f(x)=2x^2$]),
  lq.plot(xs, function4, mark: none, stroke: red.darken(30%) + 1.5pt, label: [$f(x)=0.5x^2$]),
)